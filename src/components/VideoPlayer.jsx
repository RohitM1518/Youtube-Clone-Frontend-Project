...
import { Button, Description, Comment, Input, VideoCard } from '.'
...
export const VideoPlayer = ({ video, subscibersCount, comments }) => {
  ...
  return (
    ...
    <div className=' text-black flex flex-col gap-2 h-3/4 w-3/4'>
      <div className=''>
      ...
      <div className=' text-white flex flex-col gap-2 font-sans font-semibold'>
        ...
        <div className='flex gap-6 items-center'>
          <div className=' flex gap-2 items-center'>
            ...
            <div>
              <h1 className=' text-xl'>{video?.owner?.fullname}</h1>
    ...
    <div className='  text-white grid gap-12 h-auto grid-cols-1 justify-center' >
        {
          videos.map((video) => (
